...
$routes->setDefaultController('thinkframe');
$routes->setDefaultMethod('questions');
...
$routes->get('/', 'Thinkframe::questions');
$routes->get('getdatainjson/questions_frontend',
'Getdatainjson::questions_frontend');
