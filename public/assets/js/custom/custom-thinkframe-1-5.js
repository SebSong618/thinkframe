    ...
    var labels_set = '<div class="label-set" hyp_id="{{hyp_id}}">' +
                        '<input type="text" placeholder="Please enter label."  class="form-control form-control-solid label_m_100" />' +
                        '<input type="text" placeholder="Please enter label."  class="form-control form-control-solid label_m_50" />' +
                        '<input type="text" placeholder="Please enter label."  class="form-control form-control-solid label_0" />' +
                        '<input type="text" placeholder="Please enter label."  class="form-control form-control-solid label_p_50" />' +
                        '<input type="text" placeholder="Please enter label."  class="form-control form-control-solid label_p_100" />' +
                     '</div>';

    var scale_labels = '<div class="scale-label" hyp_id="{{hyp_id}}">' +
                            '<input class="label label_m_100" type="text" value="{{label_m_100}}">' + 
                            '<input class="label label_m_50" type="text" value="{{label_m_50}}">' +
                            '<input class="label label_0" type="text" value="{{label_0}}">' +
                            '<input class="label label_p_50" type="text" value="{{label_p_50}}">' +
                            '<input class="label label_p_100" type="text" value="{{label_p_100}}">' +
                       '</div>';
    ...
    var option_in_hyp =     '<div class="option-box" id="option_box_{{question_id}}_{{option_id}}" question_id="{{question_id}}" option_id="{{option_id}}">' +
                                '<input type="text" read-only  value="{{option_hyp_point}}" id="{{option_hyp_id}}"  class="form-control form-control-solid option-point-hyp">' +
                                '<input type="range" min="-100" max="100" style="visibility:{{range_show}}" value="{{option_hyp_point}}" class="slider-{{strength}} hyp-option-range">'+
                                '<select class="strength-list" id="strength_link_{{option_hyp_id}}">' +
    ...
    var advice_combo_box =  '<div class="combo-box" combo_id="{{combo_id}}" combo_advice_id="{{combo_advice_id}}">'+
                                '<input type="text" id="{{combo_advice_id}}" placeholder="power" value="{{combo_power}}" class="form-control form-control-solid combo-power" />'+
     ...
     var advice_hyp_box =  '<div class="hyp-box" hyp_id="{{hyp_id}}" advice_hyp_id="{{advice_hyp_id}}">'+
                                '<input type="text" id="{{advice_hyp_id}}" placeholder="power" value="{{hyp_power}}" class="form-control form-control-solid hyp-power" />'+
                                '<input type="range" style="visibility:{{range_show}}" value="{{hyp_power}}" class="form-range advice-hyp-range">'+
