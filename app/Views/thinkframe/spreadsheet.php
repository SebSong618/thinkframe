...
<div class="post d-flex flex-column-fluid" id="kt_post">
    ...
    <div id="kt_content_container" class="container">
        ...
        <div class="card combo-page">
        	<p style="font-weight: bold; text-align: center; margin-top: 10px;">Upload Excel Template File.</p>
            <?php echo form_open_multipart('excelsheet/import',array('name' => 'spreadsheet')); ?>
			<table align="center" cellpadding = "5">
				<tr>
				<td>File :</td>
				<td><input type="file" size="40px" name="upload_file" /></td>
				<td><input type="input" placeholder="e.g my_hobby" name="scope_name" size="40px" /></td>
				<td class="error"><?php // echo form_error('name'); ?></td>
				<td colspan="5" align="center">
				<input type="submit" value="Import Excel File"/></td>
				</tr>
			</table>
			<?php echo form_close();?>
        </div>
