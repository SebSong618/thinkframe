                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span><?= $input['input_time'] ?></span>
                                    </td>
                                    
                                    <td>
                                        <span><?= $input['scope_slug'] ?></span>
                                    </td>

                                    <td>
                                        <a target="_blank" href="https://thinkframe-quiz.herokuapp.com/quiz/<?= $input['scope_slug'] ?>/<?= $input['user_name'] ?>">https://thinkframe-quiz.herokuapp.com/quiz/<?= $input['scope_slug'] ?>/<?= $input['user_name'] ?></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
